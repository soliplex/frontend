...
const SP_LIGHT = {
  ...
  warningContainer:'#FEF3C7', onWarningContainer:'#92400E',
  infoContainer:'#DBEAFE', onInfoContainer:'#1E40AF',
  danger:'#F44336', success:'#4CAF50', warning:'#FF9800', info:'#2196F3',
...
const SP_DARK = {
  ...
  warningContainer:'#3D2E12', onWarningContainer:'#FCD34D',
  infoContainer:'#1A1A3D', onInfoContainer:'#93C5FD',
  danger:'#E57373', success:'#81C784', warning:'#FFB74D', info:'#64B5F6',
