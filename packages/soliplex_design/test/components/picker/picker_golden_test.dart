...
void main() {
  testWidgets('PickerGallery — light', (tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/picker_gallery_light.png'),
    );
  });

  testWidgets('PickerGallery — dark', (tester) async {
    tester.view.physicalSize = const Size(700, 1900);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    ...
    await expectLater(
      find.byType(MaterialApp),
      matchesGoldenFile('goldens/picker_gallery_dark.png'),
    );
  });
}
