...
void main() {
  testWidgets('ButtonGallery — light', (tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/button_gallery_light.png'),
    );
  });

  testWidgets('ButtonGallery — dark', (tester) async {
    tester.view.physicalSize = const Size(900, 1100);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    ...
    await expectLater(
      find.byType(MaterialApp),
      matchesGoldenFile('goldens/button_gallery_dark.png'),
    );
  });
}
