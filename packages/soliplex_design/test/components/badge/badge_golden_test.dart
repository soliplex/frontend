...
void main() {
  testWidgets('BadgeGallery — light', (tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/badge_gallery_light.png'),
    );
  });

  testWidgets('BadgeGallery — dark', (tester) async {
    tester.view.physicalSize = const Size(900, 600);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.reset);
    ...
    await expectLater(
      find.byType(MaterialApp),
      matchesGoldenFile('goldens/badge_gallery_dark.png'),
    );
  });
}
